...
use commonware_cryptography::{bls12381::primitives::variant::MinSig, Digestible, Hasher};
    ...
    E: Rng + Spawner + Metrics + Clock,
{
    ...
    pub fn start(mut self, marshal: marshal::Mailbox<MinSig, B>, dkg: dkg::Mailbox) -> Handle<()> {
        self.context.spawn_ref()(self.run(marshal, dkg))
    }

    /// Application control loop
    async fn run(mut self, mut marshal: marshal::Mailbox<MinSig, B>, dkg: dkg::Mailbox) {
