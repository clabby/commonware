...
> {
    ...
    SubscribeChunk {
        ...
        response: oneshot::Sender<Shard<B, H>>,
    },
...
#[derive(Clone)]
pub struct Mailbox<V: Variant, B: Block<Digest = H::Digest, Commitment = H::Digest>, P: PublicKey, H: Hasher> {
    sender: mpsc::Sender<Message<V, B, P, H>>,
}

impl<V: Variant, B: Block<Digest = H::Digest, Commitment = H::Digest>, P: PublicKey, H: Hasher> Mailbox<V, B, P, H> {
...
impl<V: Variant, B: Block<Digest = H::Digest, Commitment = H::Digest>, P: PublicKey, H: Hasher> Reporter for Mailbox<V, B, P, H> {
